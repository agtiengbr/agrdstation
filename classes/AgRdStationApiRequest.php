...
class AgRdStationApiRequest extends AgObjectModel
{
    public static $definition = [
        'table'   => 'agrdstation_api_request',
        'primary' => 'id_agrdstation_api_request',
        'multilang' => false,
        'fields'  => [
            'id_agrdstation_api_request' => ['type' => self::TYPE_INT,'validate' => 'isInt'],
